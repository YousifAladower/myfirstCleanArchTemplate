...
To update the database use this command from the Web project folder (replace `myfirstClean` with your project's name):

```powershell
dotnet ef database update -c AppDbContext -p ../myfirstClean.Infrastructure/myfirstClean.Infrastructure.csproj -s myfirstClean.Web.csproj
```
